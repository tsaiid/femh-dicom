...
def global_caffe_init():
    ...
    #deploy_prototxt_file_path = 'FEMH_nofinding_0704.prototxt'
    #caffe_model_file_path = 'FEMH_nofinding_0704.caffemodel'
    #deploy_prototxt_file_path = 'FEMH_cardiomegaly_0607.prototxt'
    #caffe_model_file_path = 'FEMH_cardiomegaly_0607.caffemodel'
    ...
    #mean_file_path = 'ChestXRay_mean0704.binaryproto'
...
def main():
    ...
    for i in range(top_conf.shape[0]):
        ...
        print("{} {} {} {} {} {}".format(label, score, xmin, ymin, xmax, ymax))
